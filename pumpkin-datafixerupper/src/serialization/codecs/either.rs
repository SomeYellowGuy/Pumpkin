...
mod test {
    ...
    use crate::serialization::codecs::either::EitherCodec;
    use crate::serialization::codecs::primitive::{DoubleCodec, IntCodec, StringCodec};
    ...
    use crate::serialization::struct_codecs::StructCodec2;
